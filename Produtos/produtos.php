...
<html lang="pt-br">
    ...
    <body>
        ...
        <main class="modal">
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th class="ver" style="width: 10%;">Ver</th>
                    </tr>
                </thead>
                <tbody>
                        ...
                        <tr>
                            ...
                            <td class="table-center">
                                <form action="../Editarproduto/editarProduto.php" method="POST">
                                    <input type="hidden" value="<?= $produto['id']; ?>" name="id">
                                    <input type="submit" value="Editar" style="border: none; background: none; color: #f7211a; cursor: pointer;" onMouseOver="this.style.color='#04E813'" onMouseOut="this.style.color='#F21CD5'">
                                </form>
                            </td>
                            <td class="table-center">
                                <form action="../Produto/produto.php" method="POST">
                                    <input type="hidden" value="<?= $produto['id']; ?>" name="id">
                                    <input type="submit" value="&#9654;" style="border: none; background: none; color: #7ff847; cursor: pointer;">
                                </form>
                            </td>
                        </tr>
                    <?php endforeach; ?>
            ...
            <div class="botao">
                <a href="../CreateProduto/createProduto.php"><button class="botao-configurado">Registre o produto</button></a>
            </div>
        </main>
